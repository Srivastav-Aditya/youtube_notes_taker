...
const Notes = ({ notes, onAddNote, onDeleteNote, onEditNote, onTimestampClick }) => {
  ...
  return (
    <div className="notes-section max-w-xl min-w-full mt-6 p-4 border border-black rounded bg-white">
        ...
        {notes.map(note => (
          <li key={note.id} className="flex justify-between items-center mb-2 p-2 border-b">
            <div className="flex flex-col">
              <span className="cursor-pointer text-blue-500" onClick={() => onTimestampClick(note.time)}>
